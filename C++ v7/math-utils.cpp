...
int math_power_copy;
unsigned long long math_n_copy;

unsigned long long threePowers[40] = {
...
void spreadAndOrBits(unsigned long long x, unsigned long long *low, unsigned long long *high) {
	unsigned long long xLow = x & 0x00000000FFFFFFFF;
	unsigned long long xHigh = (x & 0xFFFFFFFF00000000) >> 32;
